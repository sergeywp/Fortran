...
REAL*8 PT(NIJ),QT(NIJ),TEMP(NI,NJ,NK),DX,DY,DZ
...
!      	IF (ITER.NE.LAST) RETURN
   	...
   	OPEN(UNIT=3,FILE='ALLcons_99_400.DAT',STATUS='UNKNOWN')
...
!=====================================================
SUBROUTINE SOLVE_1(IST, JST, KST, NTIMES, F)
USE VAR
IMPLICIT NONE
